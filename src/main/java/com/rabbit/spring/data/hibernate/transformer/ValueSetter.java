package com.rabbit.spring.data.hibernate.transformer;

import com.rabbit.spring.data.hibernate.transformer.mappedfileds.CollectionFields;
import com.rabbit.spring.data.hibernate.transformer.mappedfileds.Fields;
import com.rabbit.utils.JpaConstants;
...
public class ValueSetter {
    ...
    public void set(Object instantiate, String alias, Object value, Map<String, Fields> mappedFields) {
        ...
        if (!alias.contains(JpaConstants.OBJECT_SPLIT)) {
        ...
        int index = alias.indexOf(JpaConstants.OBJECT_SPLIT);
        ...
        if (field.isMap()) {
            if (remainAlias.contains(JpaConstants.OBJECT_SPLIT)) {
