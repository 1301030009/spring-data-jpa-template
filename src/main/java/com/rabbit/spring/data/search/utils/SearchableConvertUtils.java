 ...
 */
package com.rabbit.spring.data.search.utils;

import com.rabbit.spring.data.search.SearchOperator;
import com.rabbit.spring.data.search.Searchable;
import com.rabbit.spring.data.search.exception.SearchException;
import com.rabbit.spring.data.search.filter.AndCondition;
import com.rabbit.spring.data.search.filter.Condition;
import com.rabbit.spring.data.search.filter.OrCondition;
